package com.example.sakshi.toast;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "This is my toast in oncreat", Toast.LENGTH_SHORT).show();

        Toast centerToast =Toast.makeText(this, "This is my toast in oncreat", Toast.LENGTH_SHORT);
    ...
    protected void onPause() {
        super.onPause();
        Toast.makeText(this, "This is my toast in pause", Toast.LENGTH_SHORT).show();
